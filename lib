...
library.theme = {
    ...
    -- deep radioactive bunker vibes ☢️
    backgroundcolor = Color3.fromRGB(20, 20, 20),

    -- text
    tabstextcolor = Color3.fromRGB(210, 255, 210),
    toptextcolor = Color3.fromRGB(235, 255, 235),

    -- borders / outlines
    bordercolor = Color3.fromRGB(55, 95, 55),
    outlinecolor = Color3.fromRGB(70, 120, 70),
    outlinecolor2 = Color3.fromRGB(0, 0, 0),

    -- toxic green accents
    accentcolor = Color3.fromRGB(110, 255, 80),
    accentcolor2 = Color3.fromRGB(45, 140, 35),

    -- panels
    sectorcolor = Color3.fromRGB(28, 32, 28),

    -- topbar
    topheight = 48,
    topcolor = Color3.fromRGB(24, 28, 24),
    topcolor2 = Color3.fromRGB(18, 22, 18),

    -- buttons
    buttoncolor = Color3.fromRGB(40, 55, 40),
    buttoncolor2 = Color3.fromRGB(30, 42, 30),

    -- misc item text
    itemscolor = Color3.fromRGB(180, 255, 180),
    itemscolor2 = Color3.fromRGB(140, 230, 140)
}
